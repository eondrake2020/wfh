    ...
    <body>
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                ...
                <div class="bg-image" style="background-image: url('<?php echo asset('public/assets/media/photos/wfh2.png'); ?>">
                    <div class="row mx-0">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                <p class="font-size-h3 font-w600 text-black" style="text-transform: uppercase; font-weight: bolder;">
                                    Holy Child College of Davao <br>Attendance and Task Monitoring System
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="#">
                                        <span class="font-size-xl text-primary-dark">HCCD - WFH</span>
                                    </a>
